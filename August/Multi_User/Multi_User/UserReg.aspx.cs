...
namespace Multi_User
{
    public partial class UserReg : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string ins = "insert into usertb values(" + regid + ",'" + TextBox1.Text + "','" + TextBox2.Text + "')";
            int i = ob.fn_ExecuteNonQuery(ins);
            if (i == 1)
            {
                string inslog = "insert into login values(" + regid + ",'" + TextBox3.Text + "','" + TextBox4.Text + "','user','active')";
